//
//  BotsTableViewController.swift
//  HelloWorld
//
//  Created by Alex Finkel on 2016-02-09.
...
class BotsTableViewController: UITableViewController {
    ...
    lazy var server: XcodeServer = {
        do {
            let config = try XcodeServerConfig(host: kXcodeServerUrl)
    ...
    // MARK: - XCodeServer API
//    func getXcodeServerInstance(serverUrlStr: String) -> XcodeServer {
//        let config = XcodeServerConfig(host: serverUrlStr)
//        let endpoints = XcodeServerEndpoints(serverConfig: config)
//        return XcodeServer(config: config, endpoints: endpoints)
//    }
